...
public class CardManager : MonoBehaviour
{
    ...
    [SerializeField] private Dictionary<ECardShape, List<Sprite>> cardSpriteDictionary = new Dictionary<ECardShape, List<Sprite>>();
    [SerializeField] private Dictionary<ECardShape, List<Card>> cardDictionary = new Dictionary<ECardShape, List<Card>>();
...
public class StringAsNumericComparer : IComparer<Sprite>
{
    ...
    //    {
    //        return StringLogicalComparer.Compare((Sprite)x, (Sprite)y);
    //    }
    ...
    {
        public static int Compare(Sprite spr1, Sprite spr2)
        {
            string s1 = spr1.name;
            string s2 = spr2.name;
